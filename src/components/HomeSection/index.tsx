...
export const HomeSection = (): JSX.Element => {
  return (
    <section id="inicio" className="w-screen flex flex-col items-center justify-center z-0 border-b-4 pb-16 bg-gradient-invert mt-32">
      <div className=" w-3/5 self-center gap-8 border border-yellow-300">
        ...
        <h1 className="text-6xl font-bold leading-tight tracking-normal">
          ...
          <span className="text-blue-700">criatividadde</span>, transformo
